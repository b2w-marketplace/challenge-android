...
import com.danilodequeiroz.webapi.providesLivrRulesRetrofitClient
...
val presentationModule = module {
    single<LodjinhaRestRepository>  { providesLivrRulesRetrofitClient().create(LodjinhaRestRepository::class.java) }
