...
class BestSellersAdapter(private val context: HomeActivity, private val productList: List<Product>)
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view), View.OnClickListener{
        ...
        override fun onClick(view: View?) {
            context.onItemClick(adapterPosition, HomeActivity.RecyclerViewCode.BEST_SELLERS)
        }
    }
}