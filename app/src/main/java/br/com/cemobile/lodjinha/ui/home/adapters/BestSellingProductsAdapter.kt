...
import br.com.cemobile.lodjinha.ui.product.list.adapters.ProductsDiffCallback
...
) : ListAdapter<Product, BestSellingProductsAdapter.ViewHolder>(ProductsDiffCallback()) {
