...
class ProdutoServiceImpl : ProdutoServiceApi {
    ...
    override fun produtoFindByCategoria(
        ...
        offset: Int,
        limit: Int,
        callback: ProdutoServiceApi.ServiceCallback<ReturnBase>
    ) {
    ...
    override fun reservarProdutoById(produtoId: Int, callback: ProdutoServiceApi.ServiceCallback<ReturnBase>) {
    ...
    override fun produtoMaisVendidos(callback: ProdutoServiceApi.ServiceCallback<ReturnBase>) {
